...
.DESCRIPTION
Injects a <dependency> node into a Chocolatey package nuspec file. Useful for creating complex metapackages
or modifying an existing package to include a new dependency.
